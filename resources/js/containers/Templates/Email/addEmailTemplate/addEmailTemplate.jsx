...
const App = ({ onExport, toggleModal }) => {
        ...
        <div>
            <div>
                ...
                <Row justify="end" className="mb-3">
                    <Button loading={loadingEmailTemplateAddButton} onClick={exportJson}>Save</Button>
                </Row>
                ...
                <Row gutter={[0, 5]}>
                    ...
                    <Col xs={22} md={22} lg={22} xl={22} xxl={22}>
                        <Input type="text" name="subject" value={subject} onChange={onInputHandler} />
                    </Col>
                    ...
                    <Col xs={22} md={22} lg={22} xl={22} xxl={22}>
                        <Select onChange={onSelectHandler} value={category} style={{ width: '100%' }}>
